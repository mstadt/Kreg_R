...
% Meal + KCl
fname1 = "2023-06-23_MealSim_Kin-35_doIns-1_notes-Meal+KCl.csv";
dat1   = readtable(strcat("./results/",fname1));
pars1  = readtable(strcat("./results/", "params_",fname1));
lab1   = "Meal + KCl";

% KCl only
fname2 = "2023-06-23_MealSim_Kin-35_doIns-0_notes-KClOnly.csv";
dat2   = readtable(strcat("./results/",fname2));
pars2  = readtable(strcat("./results/", "params_",fname2));
lab2   = 'KCl Only';

% Meal only
fname3 = "2023-06-23_MealSim_Kin-0_doIns-1_notes-MealOnly.csv";
dat3   = readtable(strcat("./results/",fname3));
pars3  = readtable(strcat("./results/", "params_",fname3));
lab3   = 'Meal Only';
...
plot(dat3.time, dat3.amt_gut,'linewidth',lw,'color',c3,'linestyle',ls3)
...
plot(dat2.time, dat2.amt_plas,'linewidth',lw,'color',c2, 'linestyle',ls2)
plot(dat3.time, dat3.amt_plas,'linewidth',lw,'color',c3, 'linestyle',ls3)
...
plot(dat2.time,dat2.amt_inter,'linewidth',lw,'color',c2, 'linestyle',ls2)
plot(dat3.time,dat3.amt_inter,'linewidth',lw,'color',c3, 'linestyle',ls3)
...
plot(dat2.time,dat2.amt_muscle,'linewidth',lw,'color',c2, 'linestyle',ls2)
plot(dat3.time,dat3.amt_muscle,'linewidth',lw,'color',c3, 'linestyle',ls3)
...
plot(dat2.time,dat2.amt_inter/pars2.V_inter,'linewidth',lw,'color',c2, 'linestyle',ls2)
plot(dat3.time,dat3.amt_inter/pars3.V_inter,'linewidth',lw,'color',c3, 'linestyle',ls3)
yline(3.5,'color',cgray,'linestyle',lsgray, 'linewidth', lwgray)
yline(5.0,'color',cgray,'linestyle',lsgray, 'linewidth', lwgray)
...
plot(dat2.time,dat2.amt_muscle/pars2.V_muscle,'linewidth',lw,'color',c2, 'linestyle',ls2)
plot(dat3.time,dat3.amt_muscle/pars3.V_muscle,'linewidth',lw,'color',c3, 'linestyle',ls3)
hold on
